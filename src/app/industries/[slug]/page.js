...
import { INDUSTRIES, getIndustryBySlug, getAllIndustries } from '@/lib/industries';
...
export default function IndustryPage({ params }) {
  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '40px 20px' }}>
      ...
      {/* 热门采购国家 */}
      <div style={{ marginBottom: 40 }}>
        <h2 style={{ fontSize: 20, fontWeight: 700, color: '#0f172a', marginBottom: 16 }}>🌍 热门采购国家</h2>
      ...
      <div style={{ background: '#fff8f0', borderRadius: 12, padding: 28, marginBottom: 40 }}>
        <h2 style={{ fontSize: 20, fontWeight: 700, color: '#0f172a', marginBottom: 16 }}>😤 {industry.zh}外贸获客常见问题？</h2>
